...
def main():
    ...
    print("The average turn around time with 2GHz = %f" % AVGTTRS)
    print("The average wait time with 2GHz = %f" % AVG_Wait_Time)
    print("The average turn around time with 4GHz = %f" % AVGTTRS2)
    print("The average wait time with 4GHz = %f" % AVG_Wait_Time2)
