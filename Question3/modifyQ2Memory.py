...
def waitTime(csv_reader):
    Wait_Times = []
    # first process's wait time is 0
    Wait_Time = 0
    ...
    for process in csv_reader:
        if process != "Bursttime":
            ...
            # wait time is the sum of burst times of all previous processes
...
def main():
    ...
    print("The average turn around time with 8 GB = %f" % AVGTTRS)
    print("The average wait time with 8 GB = %f" % AVG_Wait_Time)
    print("The average turn around time with 16 GB = %f" % AVGTTRS2)
    print("The average wait time with 16 GB = %f" % AVG_Wait_Time2)
